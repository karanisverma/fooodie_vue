<template>
  <div id="app">
    ...
    <router-view @toggleSidebar="showSidebar = !showSidebar" @showLogin="loginModel = true" @toggleCartSidebar ="showCartSidebar = !showCartSidebar"></router-view>
      ...
      <div class="web-wrapper">
        ...
        <div class="copyright-social">
          ...
          <div class="social-links">
            ...
            <div class="social">
              <a href="https://www.facebook.com/fooodie.store/" target="_blank">
            ...
            <div class="social">
              <a href="https://www.instagram.com/fooodie.store/" target="_blank">
